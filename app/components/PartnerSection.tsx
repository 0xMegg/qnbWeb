  ...
  return (
    <>
      ...
      >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 text-left">
          {PROCESS_DATA.map((partner, index) => (
            <article
              key={index}
              className="flex flex-col border border-transparent transition-shadow transition-[border-color] duration-200 ease-out hover:shadow-[0_8px_30px_rgba(255,255,255,0.12)] hover:border-white/20 active:shadow-[0_8px_30px_rgba(255,255,255,0.12)] active:border-white/20 rounded-lg p-2 -m-2 will-change-[shadow,border-color]"
            >
              <div
